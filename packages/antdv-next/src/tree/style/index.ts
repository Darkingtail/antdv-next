...
// ============================== Switch ==============================
function getSwitchStyle(prefixCls: string, token: AliasToken): CSSObject {
  return {
...
// ============================== Merged ==============================
export function genTreeStyle(prefixCls: string, token: AliasToken & TreeSharedToken & CSSUtil,
  /**
   * @descCN 是否启用目录树样式
   * @descEN Whether to enable directory style
   * @default true
   */
  enableDirectory = true): CSSInterpolation {
...
export function initComponentToken(token: AliasToken): TreeSharedToken {
